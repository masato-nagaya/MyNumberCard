...
namespace PDC230Lib
{
    ...
    public class PDC230 : SerialPort, IDisposable
    {
        ...
        public static string[] GePortNames()
        {
            ...
            //List<string> ftdi = Ports.GetPortNames("0626", "1002");   //del 2024/12/11            
            List<string> ftdi = Ports.GetPortNames("0626", "1004");     //add 2024/12/11
        ...
        // 単体コマンド
        private readonly byte[] COMMAND_R = { 0x02, 0x52, 0x03, 0x51 };     //連続読取モード
        private readonly byte[] COMMAND_O = { 0x02, 0x4f, 0x03, 0x4c };     //1回読取
                                                                            //1回書込み
                                                                            //1回書込み（自動排出）
                                                                            //読取テスト
        ...
        private readonly byte[] COMMAND_B = { 0x02, 0x42, 0x03, 0x41 };     //カード後方排出
        private readonly byte[] COMMAND_A = { 0x02, 0x41, 0x03, 0x42 };     //LED・ブザー・自動モード設定
                                                                            //LED・ブザー・制御
                                                                            //データ転送モード
        private readonly byte[] COMMAND_V = { 0x02, 0x56, 0x03, 0x55 };     //バージョン問合せ
